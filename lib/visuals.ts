...
const STATUS_META: Record<StatusKey, StatusMeta> = {
  working: { label: "Working", bg: "#E7F4EC", color: "#146C43", dot: "#2FA45C" },
  waiting: { label: "Waiting", bg: "#FBF3E1", color: "#8A5A00", dot: "#F5A524" },
  offline: { label: "Offline", bg: "#EFEFEA", color: "#6B6B63", dot: "#ABAB9E" },
  error: { label: "Error", bg: "#FBEAEA", color: "#B42318", dot: "#E5484D" },
};
