  ...
  return (
    <>
      <style>{`
        ...
        .pd-back { font-size: 12.5px; font-weight: 600; color: var(--sf-white); background: var(--sf-primary); border: none; border-radius: 999px; padding: 8px 18px; text-decoration: none; }
        ...
        .pd-media-badge { position: absolute; top: 14px; left: 14px; font-size: 11px; font-weight: 600; letter-spacing: 0.02em; border-radius: 999px; padding: 6px 13px; box-shadow: 0 3px 12px -3px rgba(0,0,0,.35); }

        .pd-cat { display: inline-flex; font-size: 10.5px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; color: var(--sf-white); background: var(--sf-primary); border-radius: 999px; padding: 6px 14px; margin-bottom: 14px; }
        .pd-name { font-size: 25px; font-weight: 700; color: var(--sf-ink); line-height: 1.25; }
        ...
        .pd-col-title { font-size: 11.5px; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; margin-bottom: 12px; color: var(--sf-primary); }
        ...
        .pd-voucher-tag { display: inline-block; font-size: 10px; font-weight: 600; color: #1F2937; background: var(--sf-accent); border-radius: 999px; padding: 2px 9px; margin-right: 7px; vertical-align: middle; }
        ...
        .pd-comment-link { color: var(--sf-primary); font-weight: 600; word-break: break-all; }
