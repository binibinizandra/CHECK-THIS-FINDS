  ...
  return (
    <>
      <style>{`
        ...
        .pd-stars-fill { position: absolute; inset: 0; overflow: hidden; color: var(--sf-gold); white-space: nowrap; }
        .pd-rating-num { font-size: 14px; font-weight: 600; color: var(--sf-white); }
        ...
        .pd-footer-copy { font-size: 12.5px; color: var(--sf-white); text-align: center; }
